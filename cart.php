                      ...
                      <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><img src="images/product/<?php echo $product_image?>" width="100" height="100"/></td>
                            <td class="mdl-data-table__cell--non-numeric"><?php echo $product_title ?></td>
                            <td>
                              <!--Slider Number Fix-->
                              <input name="qty" onclick="myFunction()" id="slider2" class="mdl-slider mdl-js-slider" type="range" min="1" max="10" value="<?php echo $_SESSION['qty']; ?>" tabindex="1"
